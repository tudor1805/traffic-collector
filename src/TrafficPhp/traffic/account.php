...
<div class="nav-outer-repeat" style="height: 37px;">
	...
	<div class="nav-outer">
		...
		<ul class="select">
			<li><a href="table.php"><b>History</b><!--[if IE 7]><!--></a><!--<![endif]--></li>
		</ul>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
					<tr valign="top">
						<td>
							<!-- start id-form -->
							<?php
							$res = $db->query("SELECT * FROM users WHERE uuid = '".$_SESSION['user_id']."'");
							$line = $res->fetch_assoc();
							?>
							<form name="account" id="account" method="post" action="account_do.php">
								...
								<?php } else if(isset($_GET['ok']) && $_GET['ok'] == 0) { ?>
									<div id="message-red">
										<table border="0" width="100%" cellpadding="0" cellspacing="0">
											<tbody>
												<tr>
								...
								<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
									<tr>
										...
										<td><input type="text" name="name" id="name" value="<?php echo $line['name']?>" class="inp-form" /></td>
										<td></td>
									</tr>
									<tr>
										<th valign="top">Username:</th>
										<td><input type="text" autocomplete="off" name="username" id="username" value="<?php echo $line['username']?>" class="inp-form" /></td>
										<td><span id="username_error"></div></td>
									</tr>
									<tr>
										<th valign="top">New Password:</th>
										<td><input type="password" autocomplete="off" name="password" id="password" class="inp-form" /></td>
										<td></td>
									</tr>

									<tr>
										<th valign="top">Re-type Password:</th>
										<td><input type="password" autocomplete="off" name="password_re" id="password_re" class="inp-form" /></td>
										<td><span id="password_re_error"></div></td>
									</tr>

									<tr>
										<th>&nbsp;</th>
										<td valign="top">
											<input type="button" value="" onclick="checkForm(); return false;" class="form-submit" />
