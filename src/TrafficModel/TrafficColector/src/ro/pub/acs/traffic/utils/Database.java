...
public class Database {
	...
	private class CustomSQLiteOpenHelper extends SQLiteOpenHelper {
		public CustomSQLiteOpenHelper(Context context, String _database,
				String _table, String[] _columns) {
	...
	public Database(Context context, String database, String tables,
			String[] columns) {
		...
		String newTableQueryString = "create table if not exists " + table
				+ "  (id integer primary key autoincrement not null" + str
				+ ");";
		try {
	...
	public void clearTable() {
		String newTableQueryString = "DELETE FROM " + table;
		db.execSQL(newTableQueryString);
	}
	...
	public ArrayList<ArrayList<String>> getList(String groubBy) {
		...
		for (int i = 0; i < columns.length; i++)
			cols[i + 1] = columns[i];
		try {
			Cursor cursor = db.query(table, cols, null, null, groubBy, null,
					null);
